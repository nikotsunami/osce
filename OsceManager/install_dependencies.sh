...
mvn deploy:deploy-file -DgroupId=com.mattbertolini.hermes -DartifactId=hermes -Dversion=1.2.0 -Dpackaging=jar -Dfile=lib/com.mattbertolini.hermes-1.2.0.jar -Durl=file://lib -DrepositoryId=local-project-libraries
