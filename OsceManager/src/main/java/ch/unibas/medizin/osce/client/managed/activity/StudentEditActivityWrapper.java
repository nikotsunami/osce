...
public class StudentEditActivityWrapper extends StudentEditActivityWrapper_Roo_Gwt {
    ...
    public StudentEditActivityWrapper(ApplicationRequestFactory requests, View<?> view, Activity activity, EntityProxyId<ch.unibas.medizin.osce.client.managed.request.StudentProxy> proxyId) {
    ...
    public interface View<V extends ch.unibas.medizin.osce.client.scaffold.place.ProxyEditView<ch.unibas.medizin.osce.client.managed.request.StudentProxy, V>> extends View_Roo_Gwt<V> {
    }
}
