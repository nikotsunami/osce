...
public abstract class RoleSubItemValueEditActivityWrapper_Roo_Gwt implements Activity, IsScaffoldMobileActivity {
    ...
    public interface View_Roo_Gwt<V extends ch.unibas.medizin.osce.client.scaffold.place.ProxyEditView<ch.unibas.medizin.osce.client.managed.request.RoleSubItemValueProxy, V>> extends ProxyEditView<RoleSubItemValueProxy, V> {
