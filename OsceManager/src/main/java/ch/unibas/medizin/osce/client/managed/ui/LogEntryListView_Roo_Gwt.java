...
public abstract class LogEntryListView_Roo_Gwt extends AbstractProxyListView<LogEntryProxy> {
    ...
    public void init() {
        ...
        table.addColumn(new TextColumn<LogEntryProxy>() {
            ...
            @Override
            public String getValue(LogEntryProxy object) {
                return renderer.render(object.getOldValue());
            }
        }, "Old Value");
        paths.add("newValue");
        table.addColumn(new TextColumn<LogEntryProxy>() {
            ...
            @Override
            public String getValue(LogEntryProxy object) {
                return renderer.render(object.getNewValue());
            }
        }, "New Value");
    }
}
