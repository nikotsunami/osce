...
public class Messages {
			...
			public static final String PERSONS = "Personen";
			...
			public static final String ADD_PATIENT = "Patient hinzufügen";
			public static final String ADD_TRAIT = "Merkmal hinzufügen";
			public static final String ADD_ANAMNESIS_VALUE = "Anamnesewert hinzufügen";
			public static final String ADD_CLINIC = "Spital hinzufügen";
			public static final String ADD_DOCTOR = "Arzt hinzufügen";
			public static final String ADD_USER = "Benutzer hinzufügen";
			...
			public static final String SHOW_ANSWERED = "beantwortete";
			public static final String SHOW_UNANSWERED = "unbeantwortete";
}
