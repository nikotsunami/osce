...
public class AdministratorDetailsActivity extends AdministratorDetailsActivity_Roo_Gwt {
    ...
    private final ProxyDetailsView<AdministratorProxy> view;

    private AcceptsOneWidget display;

    public AdministratorDetailsActivity(EntityProxyId<ch.unibas.medizin.osce.client.managed.request.AdministratorProxy> proxyId, ApplicationRequestFactory requests, PlaceController placeController, ProxyDetailsView<ch.unibas.medizin.osce.client.managed.request.AdministratorProxy> view) {
