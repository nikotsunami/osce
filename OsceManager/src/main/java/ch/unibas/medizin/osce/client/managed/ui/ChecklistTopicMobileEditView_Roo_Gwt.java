...
public abstract class ChecklistTopicMobileEditView_Roo_Gwt extends Composite implements View<ChecklistTopicMobileEditView> {
    ...
    @UiField
    ChecklistQuestionListEditor checkListQuestions;

    @UiField
    TextBox description;

    public void setCheckListQuestionsPickerValues(Collection<ChecklistQuestionProxy> values) {
        checkListQuestions.setAcceptableValues(values);
    }
