...
public class OsceDetailsPlace extends Place {
	...
	public static class Tokenizer implements PlaceTokenizer<OsceDetailsPlace> {
		...
		public String getToken(OsceDetailsPlace place) {
			...
			if (Operation.DETAILS == place.getOperation()) {
				return place.getProxyId() + SEPARATOR + OsceDetailsPlace.Operation.DETAILS;
			}
			if (Operation.EDIT == place.getOperation()) {
				return place.getProxyId() + SEPARATOR + OsceDetailsPlace.Operation.EDIT;
			}
			if (Operation.CREATE == place.getOperation()) {
				return /*place.getProxyId() +*/ SEPARATOR + OsceDetailsPlace.Operation.CREATE.toString();
			}
