...
import ch.unibas.medizin.osce.client.managed.ui.StudentMobileEditView.Binder;
...
public class StudentMobileEditView extends StudentMobileEditView_Roo_Gwt {
    ...
    private static ch.unibas.medizin.osce.client.managed.ui.StudentMobileEditView instance;
    ...
    public static ch.unibas.medizin.osce.client.managed.ui.StudentMobileEditView instance() {
        if (instance == null) {
    ...
    @Override
    public RequestFactoryEditorDriver<ch.unibas.medizin.osce.client.managed.request.StudentProxy, ch.unibas.medizin.osce.client.managed.ui.StudentMobileEditView> createEditorDriver() {
