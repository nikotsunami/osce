...
public class FileServlet extends HttpServlet {
    ...
    public void init() throws ServletException {
        ...
        //this.basePath = OsMaFilePathConstant.getUploadBaseDIRPath() + SharedConstant.DOWNLOAD_DIR; // getServletContext().getRealPath(SharedConstant.getUploadBaseDIRPath());
        this.basePath = OsMaFilePathConstant.localSpDataDirectory;
