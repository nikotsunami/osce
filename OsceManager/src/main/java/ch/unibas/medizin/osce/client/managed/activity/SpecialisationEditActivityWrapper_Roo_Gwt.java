...
public abstract class SpecialisationEditActivityWrapper_Roo_Gwt implements Activity, IsScaffoldMobileActivity {
    ...
    public void start(AcceptsOneWidget display, EventBus eventBus) {
        view.setRoleTopicsPickerValues(Collections.<RoleTopicProxy>emptyList());
        requests.roleTopicRequest().findRoleTopicEntries(0, 50).with(ch.unibas.medizin.osce.client.managed.ui.RoleTopicProxyRenderer.instance().getPaths()).fire(new Receiver<List<RoleTopicProxy>>() {
            ...
            public void onSuccess(List<RoleTopicProxy> response) {
                ...
                view.setRoleTopicsPickerValues(values);
            }
        });
    ...
    public interface View_Roo_Gwt<V extends ch.unibas.medizin.osce.client.scaffold.place.ProxyEditView<ch.unibas.medizin.osce.client.managed.request.SpecialisationProxy, V>> extends ProxyEditView<SpecialisationProxy, V> {
