...
public class RemoteFileDownloadServlet extends HttpServlet{
	...
	String basePath;
	 ...
	 public void init() throws ServletException {
	        ...
	        this.basePath = OsMaFilePathConstant.localImageUploadDirectory;
	 ...
	 /**
	    ...
	    private void processRequest
	        ...
	        if(!file.exists()){
        	    	...
        	    	final URL url = new URL(getRemoteServerPath() + "/spImage?spImageName="+requestedFile);

        	    	BufferedImage bi=ImageIO.read(url.openStream());
        	         
        	        file=new File(OsMaFilePathConstant.localImageUploadDirectory, URLDecoder.decode(requestedFile, "UTF-8"));
        	        ImageIO.write(bi, requestedFile.substring(requestedFile.lastIndexOf(".")+1),file);
	 ...
	 // Helpers (can be refactored to public utility class) ----------------------------------------
	    ...
	    public static String getRemoteServerPath() {
			 ...
			 String  REMOTE_SERVER_PATH = ""; 
		
			  try 
			  {
				  Properties properties =  new Properties();
				  properties.load(OsMaFilePathConstant.class.getResourceAsStream("/META-INF/spring/serverInfo.properties")); 
				  REMOTE_SERVER_PATH = properties.getProperty("serverAddress");
			  }
			  catch (Exception e) 
			  {
				   e.printStackTrace();
