...
public abstract class RoleTableItemMobileListView_Roo_Gwt extends MobileProxyListView<RoleTableItemProxy> {

    protected Set<String> paths = new HashSet<String>();

    public RoleTableItemMobileListView_Roo_Gwt(String buttonText, SafeHtmlRenderer<ch.unibas.medizin.osce.client.managed.request.RoleTableItemProxy> renderer) {
