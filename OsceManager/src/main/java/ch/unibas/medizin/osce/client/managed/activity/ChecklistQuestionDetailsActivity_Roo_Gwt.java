...
public abstract class ChecklistQuestionDetailsActivity_Roo_Gwt extends AbstractActivity implements Delegate, IsScaffoldMobileActivity {

    protected ApplicationRequestFactory requests;

    protected EntityProxyId<ChecklistQuestionProxy> proxyId;

    protected void find(Receiver<EntityProxy> callback) {
        requests.find(proxyId).with("checkListTopic", "checkListOptions", "checkListCriterias").fire(callback);
    }
}
