...
public final class ResourceDownloadProps {
	...
	public enum Entity {
		STANDARDIZED_PATIENT,STANDARDIZED_ROLE, STANDARDIZED_PATIENT_EXPORT, SUMMONINGS, INDIVIDUAL_SCHEDULE, STUDENT_MANAGEMENT, CHECKLIST, STANDARDIZED_PATIENT_PAYMENT, PATIENT_IN_SEMESTER_CSV, ALARM_SCHEDULE_SUPERVISOR, STUDENT_MANAGEMENT_MIN_OPTION_VALUE,ROLE_CHECKLIST_EOSCE, ROLE_CHECKLIST_QR, EOSCE_XML
	}
}
