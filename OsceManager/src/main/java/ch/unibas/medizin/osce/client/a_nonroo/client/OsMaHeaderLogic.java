...
//		addNewPlace(placeController.getWhere());
	...
	private void addRootPlace(Place place) {
		...
		else if (place instanceof ImportObjectiveViewPlace){
			placeDescription = constants.importObjective();
		}
		//by eosce
		else if (place instanceof ImporteOSCEPlace){
		...
		else if (place instanceof ManualOscePlace){
			placeDescription = "ManualOscePlace";
		}			
		else if (place instanceof ManualOsceDetailsPlace){
			placeDescription = "ManualOsceDetailsPlace";
		}
		
		else if (place instanceof PlanSPTrainingPlace){
			placeDescription = "PlanSPTrainingPlace";
		}
		else {
