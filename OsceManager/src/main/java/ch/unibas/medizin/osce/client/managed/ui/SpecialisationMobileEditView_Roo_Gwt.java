...
public abstract class SpecialisationMobileEditView_Roo_Gwt extends Composite implements View<SpecialisationMobileEditView> {

    @UiField
    TextBox name;

    @UiField
    RoleTopicSetEditor roleTopics;
    ...
    public void setRoleTopicsPickerValues(Collection<RoleTopicProxy> values) {
        roleTopics.setAcceptableValues(values);
    }
}
