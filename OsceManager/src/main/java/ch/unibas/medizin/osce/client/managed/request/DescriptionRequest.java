...
@ServiceName("ch.unibas.medizin.osce.domain.Description")
public interface DescriptionRequest extends RequestContext {

    abstract InstanceRequest<ch.unibas.medizin.osce.client.managed.request.DescriptionProxy, java.lang.Void> persist();

    abstract InstanceRequest<ch.unibas.medizin.osce.client.managed.request.DescriptionProxy, java.lang.Void> remove();
