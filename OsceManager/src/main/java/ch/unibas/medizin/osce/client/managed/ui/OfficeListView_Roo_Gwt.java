...
public abstract class OfficeListView_Roo_Gwt extends AbstractProxyListView<OfficeProxy> {

    @UiField
    CellTable<OfficeProxy> table;

    protected Set<String> paths = new HashSet<String>();

    public void init() {
        paths.add("gender");
        table.addColumn(new TextColumn<OfficeProxy>() {
            ...
            @Override
            public String getValue(OfficeProxy object) {
