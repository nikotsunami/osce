...
public abstract class TrainingListView_Roo_Gwt extends AbstractProxyListView<TrainingProxy> {

    @UiField
    CellTable<TrainingProxy> table;

    protected Set<String> paths = new HashSet<String>();

    public void init() {
        paths.add("id");
        table.addColumn(new TextColumn<TrainingProxy>() {
            ...
            @Override
            public String getValue(TrainingProxy object) {
