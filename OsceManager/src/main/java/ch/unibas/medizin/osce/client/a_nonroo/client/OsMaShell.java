...
//	ScrollPanel scrollPanel;
	...
	public OsMaShell() {
		...
		int width = ResolutionSettings.getRightWidgetWidth() - 50;
		menuContainer.addStyleName("menuOpenContainer");
		master.setHeight(height+"px");
		master.setWidth(width+"px");
//		scrollPanel.setWidth((ResolutionSettings.getMainContainerWidth()+10)+"px");
		dockPanel.setWidth((ResolutionSettings.getMainContainerWidth()+10)+"px");
