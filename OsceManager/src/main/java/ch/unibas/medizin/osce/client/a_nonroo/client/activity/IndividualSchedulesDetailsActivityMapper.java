...
public class IndividualSchedulesDetailsActivityMapper implements ActivityMapper {
	...
	@Inject
	public IndividualSchedulesDetailsActivityMapper(OsMaRequestFactory requests, PlaceController placeController) {
	...
	public Activity getActivity(Place place) {
		...
		if (place instanceof IndividualSchedulesDetailsPlace) {
			Log.info("test");
			if(((IndividualSchedulesDetailsPlace) place).getOperation() == Operation.DETAILS)
			{
				Log.info("test");
				return new IndividualSchedulesDetailsActivity((IndividualSchedulesDetailsPlace) place, requests, placeController);
			}
			else
			{
				Log.info("test1");
