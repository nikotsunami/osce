...
public abstract class RoleItemAccessMobileEditView_Roo_Gwt extends Composite implements View<RoleItemAccessMobileEditView> {

    @UiField
    TextBox name;

    @UiField
    RoleBaseItemSetEditor roleBaseItem;
