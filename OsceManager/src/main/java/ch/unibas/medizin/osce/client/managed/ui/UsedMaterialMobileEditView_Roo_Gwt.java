...
public abstract class UsedMaterialMobileEditView_Roo_Gwt extends Composite implements View<UsedMaterialMobileEditView> {
    ...
    @UiField(provided = true)
    ValueListBox<MaterialListProxy> materialList = new ValueListBox<MaterialListProxy>(ch.unibas.medizin.osce.client.managed.ui.MaterialListProxyRenderer.instance(), new com.google.gwt.requestfactory.ui.client.EntityProxyKeyProvider<ch.unibas.medizin.osce.client.managed.request.MaterialListProxy>());
