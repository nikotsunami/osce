...
public abstract class OsceDayDetailsActivity_Roo_Gwt extends AbstractActivity implements Delegate, IsScaffoldMobileActivity {
    ...
    protected void find(Receiver<EntityProxy> callback) {
        requests.find(proxyId).with("osce", "assignments").fire(callback);
    }
}
