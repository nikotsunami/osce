...
public abstract class OscePostBlueprintMobileEditView_Roo_Gwt extends Composite implements View<OscePostBlueprintMobileEditView> {
    ...
    @UiField(provided = true)
    ValueListBox<PostType> postType = new ValueListBox<PostType>(new AbstractRenderer<ch.unibas.medizin.osce.shared.PostType>() {
    ...
    public void setPostTypePickerValues(Collection<PostType> values) {
        postType.setAcceptableValues(values);
    }
