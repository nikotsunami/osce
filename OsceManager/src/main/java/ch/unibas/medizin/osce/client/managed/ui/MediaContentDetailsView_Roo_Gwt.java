...
public abstract class MediaContentDetailsView_Roo_Gwt extends Composite implements ProxyDetailsView<MediaContentProxy> {
    ...
    public void setValue(MediaContentProxy proxy) {
        ...
        displayRenderer.setInnerText(ch.unibas.medizin.osce.client.managed.ui.MediaContentProxyRenderer.instance().render(proxy));
    }
}
