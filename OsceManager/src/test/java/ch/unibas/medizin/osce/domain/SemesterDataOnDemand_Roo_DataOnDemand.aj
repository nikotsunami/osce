...
privileged aspect SemesterDataOnDemand_Roo_DataOnDemand {
    ...
    public void SemesterDataOnDemand.setPreparationRing(Semester obj, int index) {
        Integer preparationRing = new Integer(index);
        obj.setPreparationRing(preparationRing);
    }
